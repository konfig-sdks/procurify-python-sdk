...
from procurify_python_sdk.model.paginated_permission_read_list import PaginatedPermissionReadList as PaginatedPermissionReadListSchema

from procurify_python_sdk.type.paginated_permission_read_list import PaginatedPermissionReadList

from ...api_client import Dictionary
from procurify_python_sdk.pydantic.paginated_permission_read_list import PaginatedPermissionReadList as PaginatedPermissionReadListPydantic
...
SchemaFor200ResponseBodyApplicationJson = PaginatedPermissionReadListSchema
SchemaFor200ResponseBodyTextCsv = PaginatedPermissionReadListSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaginatedPermissionReadList
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v3/permissions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaginatedPermissionReadListPydantic:
        ...
        if validate:
            return PaginatedPermissionReadListPydantic(**raw_response.body)
        return api_client.construct_model_instance(PaginatedPermissionReadListPydantic, raw_response.body)
