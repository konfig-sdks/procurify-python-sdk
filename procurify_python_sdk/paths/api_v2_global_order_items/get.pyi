...
class BaseApi(api_client.Api):
    ...
    def _get_all_order_items_mapped_args(
        self,
    ...
    async def _aget_all_order_items_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/global/order_items',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllOrderItemsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_order_items(
        self,
        account: typing.Optional[int] = None,
        account_code: typing.Optional[int] = None,
        active: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_order_items_mapped_args(
            account=account,
        ...
        return await self._aget_all_order_items_oapg(
    ...
    def get_all_order_items(
        ...
        return self._get_all_order_items_oapg(
            query_params=args.query,
        )

class GetAllOrderItems(BaseApi):
    ...
    async def aget_all_order_items(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_order_items(
            account=account,
            account_code=account_code,
            active=active,
            approved_datetime_0=approved_datetime_0,
    ...
    def get_all_order_items(
        ...
        raw_response = self.raw.get_all_order_items(
            account=account,
            account_code=account_code,
            active=active,
            approved_datetime_0=approved_datetime_0,
