...
from procurify_python_sdk.model.purchase_order_update_serializer_single import PurchaseOrderUpdateSerializerSingle as PurchaseOrderUpdateSerializerSingleSchema
...
from procurify_python_sdk.type.purchase_order_update_serializer_single import PurchaseOrderUpdateSerializerSingle
...
from procurify_python_sdk.pydantic.purchase_order_update_serializer_single import PurchaseOrderUpdateSerializerSingle as PurchaseOrderUpdateSerializerSinglePydantic
...
SchemaFor200ResponseBodyApplicationJson = PurchaseOrderUpdateSerializerSingleSchema
SchemaFor200ResponseBodyTextCsv = PurchaseOrderUpdateSerializerSingleSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PurchaseOrderUpdateSerializerSingle
    ...
    async def _aupdate_order_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v3/purchase-orders/{procurify_PO}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateOrder(BaseApi):
    ...
    async def aupdate_order(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PurchaseOrderUpdateSerializerSinglePydantic:
        ...
        if validate:
            return PurchaseOrderUpdateSerializerSinglePydantic(**raw_response.body)
        return api_client.construct_model_instance(PurchaseOrderUpdateSerializerSinglePydantic, raw_response.body)
