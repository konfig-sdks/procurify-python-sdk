...
from procurify_python_sdk.model.paginated_location_view_serializer_list_list import PaginatedLocationViewSerializerListList as PaginatedLocationViewSerializerListListSchema

from procurify_python_sdk.type.paginated_location_view_serializer_list_list import PaginatedLocationViewSerializerListList

from ...api_client import Dictionary
from procurify_python_sdk.pydantic.paginated_location_view_serializer_list_list import PaginatedLocationViewSerializerListList as PaginatedLocationViewSerializerListListPydantic
...
class FormatSchema(
    ...
    def JSON(cls):
        return cls("json")
HeadquarterSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'headquarter': typing.Union[HeadquarterSchema, bool, ],
...
request_query_headquarter = api_client.QueryParameter(
    name="headquarter",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = PaginatedLocationViewSerializerListListSchema
SchemaFor200ResponseBodyTextCsv = PaginatedLocationViewSerializerListListSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaginatedLocationViewSerializerListList
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        headquarter: typing.Optional[bool] = None,
        ...
        if headquarter is not None:
            _query_params["headquarter"] = headquarter
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaginatedLocationViewSerializerListListPydantic:
        ...
        if validate:
            return PaginatedLocationViewSerializerListListPydantic(**raw_response.body)
        return api_client.construct_model_instance(PaginatedLocationViewSerializerListListPydantic, raw_response.body)
