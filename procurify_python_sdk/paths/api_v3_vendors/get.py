...
from procurify_python_sdk.model.paginated_optimized_vendor_list import PaginatedOptimizedVendorList as PaginatedOptimizedVendorListSchema

from procurify_python_sdk.type.paginated_optimized_vendor_list import PaginatedOptimizedVendorList

from ...api_client import Dictionary
from procurify_python_sdk.pydantic.paginated_optimized_vendor_list import PaginatedOptimizedVendorList as PaginatedOptimizedVendorListPydantic

from . import path

# Query params
ExcludeOtherSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'exclude_other': typing.Union[ExcludeOtherSchema, bool, ],
...
request_query_exclude_other = api_client.QueryParameter(
    name="exclude_other",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludeOtherSchema,
    explode=True,
)
...
class VendorGroupSchema(
    ...
    @schemas.classproperty
    def CREDIT_CARD_PROVIDERS(cls):
        return cls("credit_card_providers")
    ...
    @schemas.classproperty
    def PURCHASABLE(cls):
        return cls("purchasable")
    
    @schemas.classproperty
    def REQUESTABLE(cls):
        return cls("requestable")
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'vendor_group': typing.Union[VendorGroupSchema, str, ],
    }
)
...
request_path_vendor_group = api_client.PathParameter(
    name="vendor_group",
    style=api_client.ParameterStyle.SIMPLE,
    schema=VendorGroupSchema,
    required=True,
)
_auth = [
    'BasicAuthentication',
...
SchemaFor200ResponseBodyApplicationJson = PaginatedOptimizedVendorListSchema
SchemaFor200ResponseBodyTextCsv = PaginatedOptimizedVendorListSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaginatedOptimizedVendorList
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        self,
        vendor_group: str,
        exclude_other: typing.Optional[bool] = None,
        ...
        _query_params = {}
        _path_params = {}
        if exclude_other is not None:
            _query_params["exclude_other"] = exclude_other
        ...
        if vendor_group is not None:
            _path_params["vendor_group"] = vendor_group
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaginatedOptimizedVendorListPydantic:
        ...
        if validate:
            return PaginatedOptimizedVendorListPydantic(**raw_response.body)
        return api_client.construct_model_instance(PaginatedOptimizedVendorListPydantic, raw_response.body)
