...
class BaseApi(api_client.Api):
    ...
    def _reopen_procurify_po_mapped_args(
        self,
        procurify_po: int,
    ...
    async def _areopen_procurify_po_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v3/purchase-orders/{procurify_PO}/reopen',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ReopenProcurifyPoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areopen_procurify_po(
        self,
        procurify_po: int,
        format: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._reopen_procurify_po_mapped_args(
            procurify_po=procurify_po,
            format=format,
        )
        return await self._areopen_procurify_po_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def reopen_procurify_po(
        self,
        procurify_po: int,
        format: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._reopen_procurify_po_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ReopenProcurifyPo(BaseApi):
    ...
    async def areopen_procurify_po(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areopen_procurify_po(
            procurify_po=procurify_po,
            format=format,
            **kwargs,
        )
    ...
    def reopen_procurify_po(
        ...
        raw_response = self.raw.reopen_procurify_po(
            procurify_po=procurify_po,
            format=format,
        )
