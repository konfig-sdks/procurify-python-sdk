...
class RequiredCatalogItemRead(TypedDict):
    name: str
...
class OptionalCatalogItemRead(TypedDict, total=False):
...
class CatalogItemRead(RequiredCatalogItemRead, OptionalCatalogItemRead):
    pass
