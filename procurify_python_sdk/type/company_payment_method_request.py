...
class RequiredCompanyPaymentMethodRequest(TypedDict):
    data: CompanyPaymentMethodRequestData

class OptionalCompanyPaymentMethodRequest(TypedDict, total=False):
    name: str
...
class CompanyPaymentMethodRequest(RequiredCompanyPaymentMethodRequest, OptionalCompanyPaymentMethodRequest):
    pass
