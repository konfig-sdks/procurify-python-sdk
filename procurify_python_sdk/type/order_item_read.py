...
from procurify_python_sdk.type.order_item_read_po import OrderItemReadPo
...
class RequiredOrderItemRead(TypedDict):
    account: AccountRead
...
class OptionalOrderItemRead(TypedDict, total=False):
    PO: OrderItemReadPo
...
class OrderItemRead(RequiredOrderItemRead, OptionalOrderItemRead):
    pass
