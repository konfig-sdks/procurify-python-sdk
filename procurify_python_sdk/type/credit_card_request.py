...
class RequiredCreditCardRequest(TypedDict):
    uuid: str
...
class OptionalCreditCardRequest(TypedDict, total=False):
    is_active: bool
...
class CreditCardRequest(RequiredCreditCardRequest, OptionalCreditCardRequest):
    pass
