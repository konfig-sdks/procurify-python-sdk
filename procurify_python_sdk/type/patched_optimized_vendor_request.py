...
class RequiredPatchedOptimizedVendorRequest(TypedDict):
    pass

class OptionalPatchedOptimizedVendorRequest(TypedDict, total=False):
    # Name of the vendor
    name: str
    ...
    email: PatchedOptimizedVendorRequestEmail
    ...
    payment_term_ref: typing.Optional[PaymentTermRequestNullable]

    shipping_term_ref: typing.Optional[ShippingTermRequestNullable]

    payment_method_ref: typing.Optional[PaymentMethodRequestNullable]

    shipping_method_ref: typing.Optional[ShippingMethodRequestNullable]
...
class PatchedOptimizedVendorRequest(RequiredPatchedOptimizedVendorRequest, OptionalPatchedOptimizedVendorRequest):
    pass
