...
class RequiredOptimizedVendorRequest(TypedDict):
    # Name of the vendor
    name: str
...
class OptionalOptimizedVendorRequest(TypedDict, total=False):
    active: bool
...
class OptimizedVendorRequest(RequiredOptimizedVendorRequest, OptionalOptimizedVendorRequest):
    pass
