...
class UserDocs(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "id", "firstName", "lastName", "position", "profile_image", "approval_delegatee", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "id", "firstName", "lastName", "position", "profile_image", "approval_delegatee", ], str]):
