...
class BillPurchaseOrderDocs(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "number", "currency", "total_amount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "number", "currency", "total_amount", ], str]):
