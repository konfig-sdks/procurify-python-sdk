...
class DepartmentUpsertRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["branch", "name", "external_id", "active", "punchout_email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["branch", "name", "external_id", "active", "punchout_email", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        branch: typing.Union[MetaOapg.properties.branch, decimal.Decimal, int, ],
