...
class VendorRead(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def email() -> typing.Type['VendorReadEmail']:
                return VendorReadEmail
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["email"]) -> 'VendorReadEmail': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "email", "type", "id", "active", "addressLineOne", "addressLineTwo", "postalCode", "city", "state_province", "country", "phoneOne", "phoneTwo", "fax", "comments", "contact", "url", "external_id", "dateModified", "currency", "payment_term_ref", "shipping_term_ref", "payment_method_ref", "shipping_method_ref", "payment_methods", "tax", "default_payment_method", "creditcards", "is_1099_eligible", "overall_score", "is_auto_email_po_enabled", "po_pdf_labels", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["email"]) -> 'VendorReadEmail': ...
