...
class BillStatusRead(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user", "date", "status", "bill", "id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> 'BillStatusEnum': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user", "date", "status", "bill", "id", ], str]):
