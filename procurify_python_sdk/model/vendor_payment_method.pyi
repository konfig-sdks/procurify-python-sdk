...
class VendorPaymentMethod(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['VendorPaymentMethodData']:
                return VendorPaymentMethodData
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'VendorPaymentMethodData': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["vendor", "data", "id", "name", "type", "currency", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'VendorPaymentMethodData': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["vendor", "data", "id", "name", "type", "currency", ], str]):
