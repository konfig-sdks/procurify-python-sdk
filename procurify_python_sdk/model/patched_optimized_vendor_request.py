...
class PatchedOptimizedVendorRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def email() -> typing.Type['PatchedOptimizedVendorRequestEmail']:
                return PatchedOptimizedVendorRequestEmail
            ...
            @staticmethod
            def payment_term_ref() -> typing.Type['PaymentTermRequestNullable']:
                return PaymentTermRequestNullable
        
            @staticmethod
            def shipping_term_ref() -> typing.Type['ShippingTermRequestNullable']:
                return ShippingTermRequestNullable
        
            @staticmethod
            def payment_method_ref() -> typing.Type['PaymentMethodRequestNullable']:
                return PaymentMethodRequestNullable
        
            @staticmethod
            def shipping_method_ref() -> typing.Type['ShippingMethodRequestNullable']:
                return ShippingMethodRequestNullable
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["email"]) -> 'PatchedOptimizedVendorRequestEmail': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment_term_ref"]) -> 'PaymentTermRequestNullable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["shipping_term_ref"]) -> 'ShippingTermRequestNullable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment_method_ref"]) -> 'PaymentMethodRequestNullable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["shipping_method_ref"]) -> 'ShippingMethodRequestNullable': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "active", "addressLineOne", "addressLineTwo", "postalCode", "city", "state_province", "country", "phoneOne", "phoneTwo", "fax", "email", "comments", "contact", "url", "external_id", "currency", "payment_term_ref", "shipping_term_ref", "payment_method_ref", "shipping_method_ref", "tax", "type", "default_payment_method", "is_1099_eligible", "overall_score", "is_auto_email_po_enabled", "po_pdf_labels", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["email"]) -> typing.Union['PatchedOptimizedVendorRequestEmail', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment_term_ref"]) -> typing.Union['PaymentTermRequestNullable', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["shipping_term_ref"]) -> typing.Union['ShippingTermRequestNullable', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment_method_ref"]) -> typing.Union['PaymentMethodRequestNullable', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["shipping_method_ref"]) -> typing.Union['ShippingMethodRequestNullable', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tax"]) -> typing.Union[MetaOapg.properties.tax, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type"]) -> typing.Union['VendorTypeEnum', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        email: typing.Union['PatchedOptimizedVendorRequestEmail', schemas.Unset] = schemas.unset,
        ...
        payment_term_ref: typing.Union['PaymentTermRequestNullable', schemas.Unset] = schemas.unset,
        shipping_term_ref: typing.Union['ShippingTermRequestNullable', schemas.Unset] = schemas.unset,
        payment_method_ref: typing.Union['PaymentMethodRequestNullable', schemas.Unset] = schemas.unset,
        shipping_method_ref: typing.Union['ShippingMethodRequestNullable', schemas.Unset] = schemas.unset,
        tax: typing.Union[MetaOapg.properties.tax, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        type: typing.Union['VendorTypeEnum', schemas.Unset] = schemas.unset,
        ...
        overall_score: typing.Union[MetaOapg.properties.overall_score, None, str, schemas.Unset] = schemas.unset,
