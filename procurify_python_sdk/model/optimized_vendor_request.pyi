...
class OptimizedVendorRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def email() -> typing.Type['OptimizedVendorRequestEmail']:
                return OptimizedVendorRequestEmail
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["email"]) -> 'OptimizedVendorRequestEmail': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "email", "type", "overall_score", "active", "addressLineOne", "addressLineTwo", "postalCode", "city", "state_province", "country", "phoneOne", "phoneTwo", "fax", "comments", "contact", "url", "external_id", "currency", "payment_term_ref", "shipping_term_ref", "payment_method_ref", "shipping_method_ref", "tax", "default_payment_method", "is_1099_eligible", "is_auto_email_po_enabled", "po_pdf_labels", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["email"]) -> 'OptimizedVendorRequestEmail': ...
