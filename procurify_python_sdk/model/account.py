...
class Account(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_code", "department", "id", "warning_indicator", "start_datetime", "end_datetime", "budget", "budget_used_approved", "budget_used_purchased", "balance_approved", "balance_purchased", "active", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_code", "department", "id", "warning_indicator", "start_datetime", "end_datetime", "budget", "budget_used_approved", "budget_used_purchased", "balance_approved", "balance_purchased", "active", ], str]):
