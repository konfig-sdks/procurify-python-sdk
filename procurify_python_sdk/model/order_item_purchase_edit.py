...
class OrderItemPurchaseEdit(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def custom_fields() -> typing.Type['OrderItemPurchaseEditCustomFields']:
                return OrderItemPurchaseEditCustomFields
    ...
    custom_fields: 'OrderItemPurchaseEditCustomFields'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["custom_fields"]) -> 'OrderItemPurchaseEditCustomFields': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["custom_fields"]) -> 'OrderItemPurchaseEditCustomFields': ...
