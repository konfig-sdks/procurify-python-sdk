...
class PaymentSummaryDocs(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_cost", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total_cost", ], str]):
