...
class PaymentMethodDocs(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["vendor", "currency", "id", "name", "type", "data", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["vendor", "currency", "id", "name", "type", "data", ], str]):
