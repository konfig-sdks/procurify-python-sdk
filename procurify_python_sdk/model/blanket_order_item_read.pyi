...
class BlanketOrderItemRead(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["price", "quantity", "amount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["price", "quantity", "amount", ], str]):
