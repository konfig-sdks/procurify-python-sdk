...
class Address(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "addressLineOne", "city", "postalCode", "country", "id", "state_province", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "addressLineOne", "city", "postalCode", "country", "id", "state_province", ], str]):
