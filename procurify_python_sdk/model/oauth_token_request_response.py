...
class OauthTokenRequestResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_token", "scope", "expires_in", "token_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_token", "scope", "expires_in", "token_type", ], str]):
