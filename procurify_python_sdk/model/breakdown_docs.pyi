...
class BreakdownDocs(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["score", "weight", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["score", "weight", ], str]):
