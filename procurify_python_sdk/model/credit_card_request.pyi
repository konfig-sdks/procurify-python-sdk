...
class CreditCardRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uuid", "vendor", "currency", "is_active", "name", "number", "balance", "gl_code", "type", "category", "external_id", "status", "require_activation", "last_changed_by", "payment_method", "creator", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uuid", "vendor", "currency", "is_active", "name", "number", "balance", "gl_code", "type", "category", "external_id", "status", "require_activation", "last_changed_by", "payment_method", "creator", ], str]):
