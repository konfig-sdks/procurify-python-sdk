...
class VersionChoicesDocs(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "pk", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "pk", ], str]):
