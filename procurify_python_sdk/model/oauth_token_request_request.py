...
class OauthTokenRequestRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_id", "client_secret", "audience", "grant_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_id", "client_secret", "audience", "grant_type", ], str]):
