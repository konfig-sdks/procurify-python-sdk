...
class CurrencyRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "rate", "description", "base", "active", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "rate", "description", "base", "active", ], str]):
