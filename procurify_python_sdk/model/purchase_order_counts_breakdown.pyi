...
class PurchaseOrderCountsBreakdown(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            all = schemas.IntSchema
            open = schemas.IntSchema
            partial = schemas.IntSchema
            closed = schemas.IntSchema
            cancelled = schemas.IntSchema
    ...
    cancelled: MetaOapg.properties.cancelled
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["all", "open", "partial", "closed", "cancelled", "page", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cancelled"]) -> MetaOapg.properties.cancelled: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["all", "open", "partial", "closed", "cancelled", "page", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        cancelled: typing.Union[MetaOapg.properties.cancelled, decimal.Decimal, int, ],
        closed: typing.Union[MetaOapg.properties.closed, decimal.Decimal, int, ],
        page: typing.Union[MetaOapg.properties.page, decimal.Decimal, int, ],
        partial: typing.Union[MetaOapg.properties.partial, decimal.Decimal, int, ],
