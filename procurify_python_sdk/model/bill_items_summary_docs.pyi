...
class BillItemsSummaryDocs(
    ...
    total_items: MetaOapg.properties.total_items
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_items", "total_cost", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["total_items"]) -> MetaOapg.properties.total_items: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total_items", "total_cost", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        total_items: typing.Union[MetaOapg.properties.total_items, decimal.Decimal, int, ],
