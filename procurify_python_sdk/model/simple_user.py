...
class SimpleUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "id", "firstName", "lastName", "profile_image", "department_name", "branch_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "id", "firstName", "lastName", "profile_image", "department_name", "branch_name", ], str]):
