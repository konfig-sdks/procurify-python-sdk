...
class PurchaseOrderDetail(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def shipping_method() -> typing.Type['ShippingMethod']:
            ...
            class order_items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PurchaseOrderLineItemRead']:
                        return PurchaseOrderLineItemRead
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PurchaseOrderLineItemRead'], typing.List['PurchaseOrderLineItemRead']],
                ...
                def __getitem__(self, i: int) -> 'PurchaseOrderLineItemRead':
                    return super().__getitem__(i)
            creditcard_is_editable = schemas.BoolSchema
        
            @staticmethod
            def creditcard() -> typing.Type['CreditCardReadNullable']:
                return CreditCardReadNullable
            ...
            @staticmethod
            def shipping_term() -> typing.Type['ShippingTerm']:
                return ShippingTerm
    ...
    creditcard_is_editable: MetaOapg.properties.creditcard_is_editable
    ...
    creditcard: 'CreditCardReadNullable'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["shipping_method"]) -> 'ShippingMethod': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["creditcard"]) -> 'CreditCardReadNullable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment_term"]) -> 'PaymentTerm': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["shipping_term"]) -> 'ShippingTerm': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uuid", "purchaser", "buyer_name", "buyer_contact", "buyer_addressLineOne", "buyer_postalCode", "buyer_city", "buyer_country", "buyer_address", "receiver_name", "receiver_contact", "receiver_addressLineOne", "receiver_postalCode", "receiver_city", "receiver_country", "receiver_address", "pref_vendor", "payment_terms", "shipping_terms", "shipping_method", "promise_date", "subtotal", "total", "purchased_currency", "contract", "order_items", "creditcard_is_editable", "creditcard", "payment_term", "shipping_term", "version", "number", "procurify_PO", "PO_Num", "date", "buyer_state_province", "receiver_state_province", "vendor_name", "vendor_contact", "vendor_addressLineOne", "vendor_postalCode", "vendor_city", "vendor_state_province", "vendor_country", "freight", "tax", "discount", "other", "comment", "purchased_currency_rate", "active", "state", "fulfilment_status", "disclaimer_description", "disclaimer_text", "recorded_date", "closed_date", "last_modified", "staged_for_export", "item_count", "most_recent_version", "punchout_system", "purchase_agreement", "purchase_agreement_status", "punchout_vendor_reference", "punchout_supplier_icon", "punchout_supplier_name", "has_blanket_order_items", "expiry_date", "custom_fields", "cost_details", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["shipping_method"]) -> 'ShippingMethod': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["creditcard_is_editable"]) -> MetaOapg.properties.creditcard_is_editable: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["creditcard"]) -> 'CreditCardReadNullable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment_term"]) -> 'PaymentTerm': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["shipping_term"]) -> 'ShippingTerm': ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        creditcard_is_editable: typing.Union[MetaOapg.properties.creditcard_is_editable, bool, ],
