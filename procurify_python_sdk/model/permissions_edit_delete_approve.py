...
class PermissionsEditDeleteApprove(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            can_approve = schemas.BoolSchema
            __annotations__ = {
                "can_edit": can_edit,
    ...
    can_approve: MetaOapg.properties.can_approve
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["can_approve"]) -> MetaOapg.properties.can_approve: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["can_edit", "can_delete", "can_approve", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["can_approve"]) -> MetaOapg.properties.can_approve: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["can_edit", "can_delete", "can_approve", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        can_approve: typing.Union[MetaOapg.properties.can_approve, bool, ],
