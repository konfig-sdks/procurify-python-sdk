...
from procurify_python_sdk.pydantic.optimized_vendor_email import OptimizedVendorEmail
...
class OptimizedVendor(BaseModel):
    # Name of the vendor
    name: str = Field(alias='name')

    email: OptimizedVendorEmail = Field(alias='email')

    type: VendorTypeEnum = Field(alias='type')

    overall_score: typing.Optional[str] = Field(alias='overall_score')
