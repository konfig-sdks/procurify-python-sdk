...
from procurify_python_sdk.pydantic.order_item_purchase_edit_request import OrderItemPurchaseEditRequest
from procurify_python_sdk.pydantic.purchase_order_update_request_custom_fields import PurchaseOrderUpdateRequestCustomFields
from procurify_python_sdk.pydantic.purchase_order_update_request_discount import PurchaseOrderUpdateRequestDiscount
from procurify_python_sdk.pydantic.purchase_order_update_request_tax import PurchaseOrderUpdateRequestTax

class PurchaseOrderUpdateRequest(BaseModel):
    version: int = Field(alias='version')

    order_items: typing.List[OrderItemPurchaseEditRequest] = Field(alias='order_items')
    ...
    discount: PurchaseOrderUpdateRequestDiscount = Field(alias='discount')

    tax: PurchaseOrderUpdateRequestTax = Field(alias='tax')

    custom_fields: typing.Optional[PurchaseOrderUpdateRequestCustomFields] = Field(None, alias='custom_fields')
