...
from procurify_python_sdk.pydantic.optimized_vendor_request_email import OptimizedVendorRequestEmail
...
class OptimizedVendorRequest(BaseModel):
    # Name of the vendor
    name: str = Field(alias='name')

    email: OptimizedVendorRequestEmail = Field(alias='email')
