...
from procurify_python_sdk.pydantic.user_summary_approval_delegatee import UserSummaryApprovalDelegatee
...
class UserSummary(BaseModel):
    ...
    approval_delegatee: typing.Optional[UserSummaryApprovalDelegatee] = Field(None, alias='approval_delegatee')
