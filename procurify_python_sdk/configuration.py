...
from procurify_python_sdk.exceptions_base import ApiValueError
from procurify_python_sdk.exceptions import ClientConfigurationError
...
conf = procurify_python_sdk.Configuration(
...
conf = procurify_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://your-domain.procurify.com" if host is None else host
        """Default Base url
        """
        ...
        if token_auth:
            self.api_key['tokenAuth'] = token_auth
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("procurify_python_sdk")
